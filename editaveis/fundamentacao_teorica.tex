...
produzida uma sequência de tokens que será utilizada na análise sintática \cite[pg. 796]{ref17}. 
...
Definir uma classe com detalhes de implementação em sua definição não é uma
 ...
 \texttt{\#include}, gerando dependência entre arquivos \cite{ref44}.
